...
public class PasswordGenerator {
    public static void main(String[] args) {
        ...
        System.out.println("¿Quieres mayúsculas? (s/n): ");
        String mayus = sc.nextLine();
        

        System.out.println("¿Quieres minúsculas? (s/n): ");
        String minus = sc.nextLine();

        System.out.println("¿Quieres números? (s/n): ");
        String nums = sc.nextLine();

        System.out.println("¿Quieres caracteres especiales? (s/n): ");
